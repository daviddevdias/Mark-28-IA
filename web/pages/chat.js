        ...
        <div class="chat-wrap" style="height: calc(100vh - 500px); min-height:360px;">
            ...
            <div class="chat-input-row">
                <input class="input" id="chatIn"
                       placeholder="Fale com J.A.R.V.I.S..." style="flex:1; font-size:14px; font-weight:700;">
                <button class="btn btn-accent" onclick="enviarChat()" style="padding:10px 20px;font-size:12px;letter-spacing:2px;">ENVIAR</button>
            </div>
        </div>`;
